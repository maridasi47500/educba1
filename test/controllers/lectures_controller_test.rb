...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { course_id: @lecture.course_id, text: @lecture.text } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { course_id: @lecture.course_id, text: @lecture.text } }
